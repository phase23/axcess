...
public class Missedjobs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_missedjobs);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Missedjobs.this, Dashboard.class);
        ...
        try {
            getmissedorders("https://axcess.ai/barapp/driver_missedjobs.php?driverid="+cunq);
    ...
    void getmissedorders(String url) throws IOException {
                ...
                .enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, final Response response) throws IOException {
                        ...
                        try {
                            ...
                            newtxt.setText(Html.fromHtml("No Missed orders"));
            ...
            public void run() {
                ...
                */
                ...
                for (int i = 0; i < makerows; i++) {
                    ...
                    String code = sbtns[1].trim();
                    String ismissed = sbtns[2].trim();
